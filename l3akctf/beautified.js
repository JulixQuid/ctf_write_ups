    ...
    return function() {
            ...
            (function(process) {
                ...
                var Node = function() {
                    function Node(defaults) {
                        ...
                        this.raws = {};
                        if (process.env.NODE_ENV !== "production") {
                            if (_typeof(defaults) !== "object" && typath/to/your/beautified_file.jspeof defaults !== "undefined") {
                    ...
                    _proto.warn = function warn(result, text, opts) {
                        var data = {
                            node: thispath/to/your/beautified_file.js
                        }
                    ...
                    _proto.replaceWith = function replaceWith() {path/to/your/beautified_file.js
                        if (this.parent) {
                ...
                _proto.other = function other(start) {
                    ...
                    while (token) {
                        ...
                        if (type === "(" || type === "[") {
                            ...
                            brackets.push(type === "(" ? ")" : "]")path/to/your/beautified_file.js
                            ...
                            if (!part.match(hostnamePartPattern)) {
                                ...
                                if (!newpart.match(hostnamePartPattern)) {
                                    ...
                                    if (notHost.length) {
                                        ...
                                        path/to/your/beautified_file.js   }
                            }
                        }
                    }
            ...
            Url.prototype.resolveObject = function(relative) {
                ...
                if (isRelAbs) {
                    ...
                    if (!util.isNull(result.pathname) || !util.isNull(result.search)) {
                        resulpath/to/your/beautified_file.jst.path = (result.pathname ? result.pathname : "") + (result.search ? result.search : "")
                    }
                    result.href = result.format();
                    return result
                }
        ...
        211: [function(require, module, exports) {
            ...
            function sanitizeHtml(html, options, _recursing) {
                ...
                var addedText = false;
                initializeState();
                var parser = nepath/to/your/beautified_file.jsw htmlparser.Parser({
                ...
                function escapeHtml(s, quote) {
                    ...
                    s = s.replace(/&(?![a-zA-Z0-9#]{1,adget
                        Frida’s Gadget is a shared library meant to be loaded by programs to be instrumented when the Injected mode of operation isn’t suitable.20};)/g, "&amp;").replace(/</g, "&lt;").replace(/\>/g, "&gt;");
                    if (quote) {
                        s = s.replace(/\"/g, "&quot;")
                    }
                    return s
